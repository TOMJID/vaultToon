        ...
        <div className="grid gap-6 md:grid-cols-[300px_1fr] lg:grid-cols-[400px_1fr]">
          ...
          <div className="flex flex-col">
            <div className="sticky top-6">
              <div className="overflow-hidden rounded-xl border-2 border-light-100/20 shadow-2xl">
                {coverUrl ? (
                  <img
                    src={coverUrl}
                    alt={title}
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              {status && (
                <span className="rounded-lg bg-light-100/10 px-3 py-1.5 text-sm text-white">
                  {status}
                </span>
              )}
              {year !== "Unknown" && (
              ...
              {contentRating && (
                <span className="rounded-lg bg-light-100/10 px-3 py-1.5 text-sm text-white capitalize">
                  {contentRating}
                </span>
              )}
              ...
              {originalLanguage && (
                <span className="rounded-lg bg-light-100/10 px-3 py-1.5 text-sm text-white uppercase">
                  {originalLanguage}
                </span>
              )}
            </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag) => {
                    ...
                    return (
                      <span
                        key={tag.id}
                        className="rounded-lg bg-light-100/10 px-3 py-1.5 text-sm text-light-200"
                      >
                        {tagName}
                      </span>
                    );
